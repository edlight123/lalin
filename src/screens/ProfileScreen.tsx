          ...
          <View style={styles.languageButtons}>
            ...
            >
              <Text
                style={[
                  styles.langText,
                  { color: i18n.language === 'ht' ? theme.colors.background : theme.colors.text },
                ]}
              >
                🇭🇹 Kreyòl
              </Text>
            ...
            >
              <Text
                style={[
                  styles.langText,
                  { color: i18n.language === 'fr' ? theme.colors.background : theme.colors.text },
                ]}
              >
                🇫🇷 Français
              </Text>
